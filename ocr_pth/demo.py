...
from ocr_pth.utils import CTCLabelConverter, AttnLabelConverter
from ocr_pth.dataset import RawDataset, AlignCollate
from ocr_pth.model import Model
...
class Ocr:
    ...
    def get_args(self):
        ...
        parser.add_argument('--saved_model', default = "ocr_pth/TPS-ResNet-BiLSTM-Attn.pth", help="path to saved_model to evaluation")
        """ Data processing """
